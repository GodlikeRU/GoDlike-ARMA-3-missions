class KeypadDefuse
{
	...
	controlsBackground[] = {};
  	objects[] = {};
			onLoad = "_this call ExplosivePadOnLoad";
		  onKeyDown = "_this call ExplosivePadOnKeyDown";
	...
	class controls
	{
		...
		class NumberBombType: RscText
		{
			...
			sizeEx = 0.052;
			text = "ARMA ERROR";
			x = 0.544219 * safezoneW + safezoneX;
		...
		class Bblue: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BBlueWire'] spawn COB_fnc_sequenceCompare;";
		};
		class Bwhite: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BWhiteWire'] spawn COB_fnc_sequenceCompare;";
		};
		class Byellow: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BYellowWire'] spawn COB_fnc_sequenceCompare;";
		};
		class Bgreen: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BGreenWire'] spawn COB_fnc_sequenceCompare;";
		};

		// MOD
		class BBatteryButtonframe: RscFrame
		{
			idc = -1;
			x = 0.384781 * safezoneW + safezoneX;
			y = 0.258 * safezoneH + safezoneY;
			w = 0.0135 * safezoneW;
			h = 0.0135 * safezoneH;
			colorBackground[] = {1,1,1,1};
		};
		class BBatteryButton: RscButton
		{
			idc = 1101;
			x = 0.384781 * safezoneW + safezoneX;
			y = 0.258 * safezoneH + safezoneY;
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'button_click'; ['BBatteryButton'] spawn COB_fnc_sequenceCompare;";
			tooltip = "Disconnect BATTERY cable";
		};

		class BBlackButtonframe: RscFrame
		{
			idc = -1;
			x = 0.384781 * safezoneW + safezoneX;
		...
		class BBlackButton: RscButton
		{
			...
			colorBackground[] = {1,1,1,0.25};
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'button_click'; ['BBlackButton'] spawn COB_fnc_sequenceCompare;";
			tooltip = "Push BLACK button";
		};

		class BRedButtonframe: RscFrame
		{
			idc = -1;
			x = 0.384781 * safezoneW + safezoneX;
			y = 0.3465 * safezoneH + safezoneY;
			w = 0.020625 * safezoneW;
			h = 0.033 * safezoneH;
			colorBackground[] = {1,1,1,1};
		};
		class BRedButton: RscButton
		{
			idc = -1;
			x = 0.384781 * safezoneW + safezoneX;
			y = 0.3465 * safezoneH + safezoneY;
			...
			colorBackground[] = {1,1,1,0.25};
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'button_click'; ['BRedButton'] spawn COB_fnc_sequenceCompare;";
			tooltip = "Push RED button";
		};

		class BDisconnectRibbon1frame: RscFrame
		{
			idc = -1;
			x = 0.38959 * safezoneW + safezoneX;
			y = 0.3958 * safezoneH + safezoneY;
			w = 0.010625 * safezoneW;
			h = 0.063 * safezoneH;
			colorBackground[] = {1,1,1,1};
		};
		class BDisconnectRibbon1: RscButton
		{
			idc = -1;
			x = 0.38959 * safezoneW + safezoneX;
			y = 0.3958 * safezoneH + safezoneY;
			...
			colorBackground[] = {1,1,1,0.25};
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BDisconnectRibbon1'] spawn COB_fnc_sequenceCompare;";
			tooltip = "Disconnect RIBBON";
		};

		class BDisconnectRibbon2frame: RscFrame
		{
			idc = -1;
			x = 0.485519 * safezoneW + safezoneX;
			y = 0.4528 * safezoneH + safezoneY;
			w = 0.053 * safezoneW;
			h = 0.030625 * safezoneH;
			colorBackground[] = {1,1,1,1};
		};
		class BDisconnectRibbon2: RscButton
		{
			idc = -1;
			x = 0.485519 * safezoneW + safezoneX;
			y = 0.4528 * safezoneH + safezoneY;
			...
			colorBackground[] = {1,1,1,0.25};
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; ['BDisconnectRibbon2'] spawn COB_fnc_sequenceCompare;";
			tooltip = "Disconnect RIBBON";
		};
	};
};
